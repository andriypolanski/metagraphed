...
**102 curated subnets** — 87 with a site, 44 with docs, 86 with a public repo. Live health, search, and the full list at **[metagraph.sh](https://metagraph.sh)**; per-subnet JSON at `https://api.metagraph.sh/api/v1/subnets/{netuid}`.
