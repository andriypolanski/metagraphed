      ...
      >
        <SheetHeader className="px-5 py-4 border-b border-border space-y-1">
          ...
          <p className="text-[11px] text-ink-muted leading-relaxed">
            Cross-subnet holdings for the connected wallet — validator-owned neurons and delegated
            nominator stake. Spot mark uses alpha × price; exit value simulates a 5% slippage band
            on alpha subnets.
          </p>
        </SheetHeader>
